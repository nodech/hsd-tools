...
class Packages {
  ...
  async _addPackage(pkg) {
    ...
    console.log(`Package ${pkgName} has been added.`);
    ...
    console.log(`Fetching dependencies of ${pkgName}:`);
    console.log(`  Deps: ${all.join(', ')}`);
  ...
  async addGitPackage(url) {
    ...
    console.log(`Adding git package: ${url}...`);
    ...
    console.log(`Cloning ${cloneURL} to ${directory}...`);
  ...
  async addNPMPackage(pkgName) {
    console.log(`Adding npm package ${pkgName}...`);
  ...
  async _refreshPackage(pkgName) {
    ...
    console.log(`Refreshing git and npm packages of ${pkgName}...`);
  ...
  async refreshGitPackage(pkgName) {
    ...
    console.log(`Updated ${pkgName} from ${url}.`);
  ...
  async refreshNPMPackage(pkgName) {
    ...
    console.log(`Refreshing npm info of ${pkgName}...`);
    const info = await npm.getInfo(pkgName);
    const pkg = this.pkgInfo.getPackage(pkgName);
    const npmInfo = pkg.npmInfo;

    npmInfo.setInfo(info);
    console.log(`Updated npm info of ${pkgName}.`);
  }
